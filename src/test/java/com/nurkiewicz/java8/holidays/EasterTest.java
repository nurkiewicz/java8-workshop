...
public class EasterTest {
	...
	public static Collection datesOfEaster() {
	...
	public EasterTest(int year, MonthDay easterDate) {
		this.year = year;
		this.easterDate = easterDate.atYear(year);
	}

	@Test
	public void shouldCalculateEasterSunday() {
		assertThat(Easter.sundayFor(Year.of(year))).isEqualTo(easterDate);
	}
